...
O Visual Studio é uma poderosa ferramenta de desenvolvimento, fácil de usar e simples de aprender. Atualmente, sua última versão estável é a 2017 Update 3.
...
O Visual Studio 2013 é uma IDE (Integrated Development Environment), um ambiente integrado de desenvolvimento; ou seja, uma ferramenta de desenvolvimento de aplicações para a plataforma .NET. Com uma interface amigável e integrada com os ambientes e de fácil entendimento, proporciona aos desenvolvedores a criação de aplicações sofisticadas com todos os recursos existentes, sem ter que ficar criando parte de código em um aplicativo e o restante no outro. É possível, com o Visual Studio, gerenciar recursos da máquina local e de um possível servidor, criar aplicações para Windows, web e dispositivos móveis e até jogos para consoles, como o XBox.

A sua página inicial é:

Ela pode variar de acordo com a versão instalada. Nela temos a primeira página exibida, a Start Page, onde podem ser abertos rapidamente os últimos projetos através da caixa Recent. Temos atalhos para criar e abrir um Projeto, através da caixa Start. E temos as ultimas noticias do MSDN na tela central.
